...
# KHauser, 2021-Aug-11, Modified File
# KHauser, 2021-Aug-13, Cleanup Functions
#------------------------------------------#
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        """Function to manage saving data from list of dictionaries to file

        Reads the data from 2D table (list of dicts) table into file identified by file_name 
